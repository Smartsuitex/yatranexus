...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="whatsapp-fab mobile-fab-safe fixed z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-glow transition hover:scale-105"
    >
