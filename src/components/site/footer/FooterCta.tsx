...
export function FooterCta({ whatsappBase, onPlanTrip }: FooterCtaProps) {
  ...
  return (
    <section className="relative" aria-labelledby="footer-cta-heading">
      <div
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
          ...
          <div className="flex w-full flex-col gap-3 sm:mx-auto sm:max-w-sm lg:mx-0 lg:w-auto lg:min-w-[280px]">
            <button
              type="button"
              onClick={onPlanTrip}
              className="inline-flex h-12 items-center justify-center rounded-2xl px-6 font-display text-[15px] font-bold text-white shadow-[0_12px_28px_-12px_rgba(244,124,32,0.75)] transition hover:scale-[1.03] hover:shadow-[0_14px_32px_-12px_rgba(244,124,32,0.85)] active:scale-[0.98] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
              style={{
            ...
            <a
              ...
              className="inline-flex h-12 items-center justify-center gap-2.5 rounded-2xl border bg-white px-6 font-display text-[15px] font-semibold transition hover:scale-[1.03] active:scale-[0.98] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
              style={{
