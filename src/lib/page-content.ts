...
export const DEFAULT_PAGE_CONTENT: PublicPageContent = {
  about: {
    ...
    valuesItems: [
      { icon: "TrustHandshake", title: "Trust", detail: "" },
      ...
      { icon: "ProfessionalismClipboard", title: "Professionalism", detail: "" },
      { icon: "ContinuousImprovement", title: "Continuous Improvement", detail: "" },
    ],
